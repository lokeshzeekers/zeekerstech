...
//  src/js/api.js
//
//  ⚠ Set API_BASE to your actual domain before deploying.
//    e.g. 'https://zeekerstech.com/api'
// ═══════════════════════════════════════════════════════════════

const API_BASE = '/api'; // Change to full URL when deploying: 'https://yourdomain.com/api'
...
const ApplicationsAPI = {
    ...
    updateStatus: (id, status) =>
        apiFetch(`applications.php?id=${id}`, { method: 'PUT', body: JSON.stringify({ status }) }),
...
const ContactAPI = {
    ...
    updateStatus: (id, status) =>
        apiFetch(`contact.php?id=${id}`, { method: 'PUT', body: JSON.stringify({ status }) }),
